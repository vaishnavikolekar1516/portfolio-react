      ...
      <div className="about-sections">
        ...
        <div className="about-right">
            <div className="about-para">
                ...
                <p>My experience includes developing projects such as To-Do-App, portfolio websites, and EMS System applications — with emphasis on scalable architecture, secure APIs, and intuitive UI/UX. I continuously work on improving my skills, exploring new tools, and writing efficient code that solves real problems.</p>
