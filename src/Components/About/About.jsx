      ...
      <div className="about-sections">
        ...
        <div className="about-right">
          ...
          <div className="about-para">
            ...
            MongoDB, Express.js, React, and Node.js, building full-stack
            solutions that are scalable, efficient, and visually appealing.
            </p>

            <p>
            I love turning ideas into real products—from designing intuitive
            interfaces to implementing robust backend systems. Writing clean,
            maintainable code, optimizing performance, and ensuring smooth user
            experiences are at the core of everything I build.
            </p>

            <p>
            I enjoy learning new technologies, experimenting with innovative
            tools, and staying updated with the latest trends in web development.
            Over the years, I’ve worked on projects ranging from portfolio
            websites to full-stack applications solving real-world problems.
            </p>
